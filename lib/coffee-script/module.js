...
var CoffeeScript, CoffeeScript, Compiler, cscodegen, escodegen, escodegenFormatDefaults, formatParserError, fs, Nodes, Optimiser, Parser, path, pkg, Preprocessor, run, uglifyjs;
fs = require('fs');
path = require('path');
